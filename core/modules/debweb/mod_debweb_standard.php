 ...
 */
class mod_debweb_standard extends ModeleNumRefDebWeb
{
	/**
	...
	{
		return $langs->trans("DebWebNumRefModelDesc", $this->prefix);
	}
	...
	public function getNextValue($object)
	{
		...
		if ($resql) {
			...
			dol_syslog("mod_debweb_standard::getNextValue", LOG_DEBUG);
			return -1;
		}

		if ($max >= (pow(10, 6) - 1)) {
			$num = '000000'; //max num reached
		} else {
			$num = sprintf("%06s", $max + 1);
		}

		dol_syslog("mod_debweb_standard::getNextValue return ".$this->prefix.$num);
